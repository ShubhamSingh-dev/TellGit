...
// import { BorderGlow } from "@/components/ui/glow-effect";
...
interface PricingProps {
  ...
  title?: string;
  description?: string;
  renderPlanButton?: (plan: PricingPlan) => React.ReactNode;
}
...
export function Pricing({
  ...
  const getHref = (plan: PricingPlan) => {
    if (typeof plan.href === "string") {
      return plan.href;
    }
    return isMonthly ? plan.href.monthly : plan.href.annual;
  };

  return (
    <div className="container py-20">
      <div className="mb-12 space-y-4 text-center">
        <h2 className="font-heading mb-6 text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
          {title}
        </h2>
