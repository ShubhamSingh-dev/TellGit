...
export const env = createEnv({
  ...
  server: {
    ...
    STRIPE_WEBHOOK_SECRET: z.string().min(1).optional().default("dummy"),
    STRIPE_PUBLISHABLE_KEY: z.string().min(1).optional().default("dummy"),
    ASSEMBLYAI_API_KEY: z.string().min(1).optional().default("dummy"),
    SUPABASE_PASS: z.string().min(1).optional().default("dummy"),
  },
  ...
  client: {
    ...
    NEXT_PUBLIC_SUPABASE_URL: z.string().url().optional().default("https://dummy.supabase.co"),
    NEXT_PUBLIC_SUPABASE_ANON_KEY: z.string().min(1).optional().default("dummy"),
  },
